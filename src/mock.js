// Mock data for SVG icons application

export const mockCategories = [
  { id: 'business', name: 'Business', count: 45 },
  { id: 'social', name: 'Social Media', count: 32 },
  { id: 'arrows', name: 'Arrows', count: 28 },
  { id: 'interface', name: 'Interface', count: 67 },
  { id: 'technology', name: 'Technology', count: 41 },
  { id: 'communication', name: 'Communication', count: 25 },
  { id: 'finance', name: 'Finance', count: 19 },
  { id: 'shopping', name: 'Shopping', count: 31 },
  { id: 'travel', name: 'Travel', count: 22 },
  { id: 'food', name: 'Food & Drink', count: 18 }
];
...
export const mockIcons = [
  // Business Category
  {
    ...
    name: 'Briefcase',
    category: 'business',
    tags: ['work', 'business', 'office', 'professional'],
    svgContent: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8 7V5C8 4.44772 8.44772 4 9 4H15C15.5523 4 16 4.44772 16 5V7M8 7H3C2.44772 7 2 7.44772 2 8V18C2 18.5523 2.44772 19 3 19H21C21.5523 19 22 18.5523 22 18V8C22 7.44772 21.5523 7 21 7H16M8 7H16" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>`,
    downloads: 1234,
    featured: true
  },
  {
    ...
    name: 'Chart Bar',
    category: 'business',
    tags: ['chart', 'analytics', 'data', 'statistics'],
    svgContent: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    name: 'Settings',
    category: 'interface',
    tags: ['settings', 'gear', 'configuration', 'options'],
    svgContent: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  // Technology Category
  {
    ...
    name: 'Smartphone',
    category: 'technology',
    tags: ['phone', 'mobile', 'device', 'technology'],
    svgContent: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M17 2H7C6.46957 2 5.96086 2.21071 5.58579 2.58579C5.21071 2.96086 5 3.46957 5 4V20C5 20.5304 5.21071 21.0391 5.58579 21.4142C5.96086 21.7893 6.46957 22 7 22H17C17.5304 22 18.0391 21.7893 18.4142 21.4142C18.7893 21.0391 19 20.5304 19 20V4C19 3.46957 18.7893 2.96086 18.4142 2.58579C18.0391 2.21071 17.5304 2 17 2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
export const featuredIcons = mockIcons.filter(icon => icon.featured);
